...
<Modal>
            ...
            <Menus.Menu>
              ...
              {/* <Menus.Button icon={<HiTrash/>} disabled={isDeleting} onClick={()=>handleDeleteBooking(bookingId)}>Delete Booking</Menus.Button> */}
...
<Menus.Button icon={<HiTrash/>}>Delete booking</Menus.Button>
                    ...
                    <Modal.Window name='delete'>
                      <ConfirmDelete resourceName='booking' disabled={isDeleting} onConfirm={()=>handleDeleteBooking(bookingId)} />
                    </Modal.Window>
              </Modal>
    </Table.Row>
  );
